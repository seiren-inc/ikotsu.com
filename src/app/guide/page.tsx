...
粉骨をすると、遺骨の体積が元の約1/3〜1/5に減少します。粉骨後は一回り小さな骨壺・容器への収納が可能です。手元供養用の小型骨壺（1寸〜2寸）から、海洋散骨用の水溶袋まで幅広くご案内しています。
  ...
  {
    slug: 'faq-corporate',
    title: '法人が粉骨・洗骨を外部委託するときのよくある質問|寺院・霊園・葬儀社向け',
    category: 'process',
    description: '寺院・霊園・葬儀社・納骨堂が粉骨や洗骨を外部委託する際のよくある疑問。インボイス・NDA・受領書・複数体一括処理・月次変動対応などを解説。',
    readTime: '6分',
    content: `
寺院や霊園が粉骨・洗骨を外部委託する場合、個人依頼とは異なる確認事項があります。
...
施設への定期集荷に対応しています（関東圏は即日調整可・他県は要相談）。入出荷のスケジュール調整は専任担当が行います。
  ...
  {
    slug: 'decision-flow',
    title: 'どのサービスを選べばいい？遺骨の状態別・目的別の判断フロー',
    category: 'process',
    description: '粉骨・洗骨・セットプランのどれを選ぶべきかわからない方向けの判断フロー。遺骨の出どころ（火葬後・墓から・土付き）とカビの有無で最適なプランが決まります。',
    readTime: '4分',
    content: `
「粉骨だけでいいの？洗骨も必要？」という判断には、遺骨の出どころと状態の確認が必要です。
...
遺骨の状態をお伝えいただければ、当社スタッフが状態を確認し最適なプランをご提案します。無料相談フォームまたはLINEでご連絡ください。
  ...
  {
    slug: 'faq-individual',
    title: '粉骨・洗骨を依頼するときのよくある質問10選|個人向け',
    category: 'process',
    description: '粉骨・洗骨を個人で初めて依頼するときに必ず確認すべき疑問10選。取り違え防止・証明書の内容・六価クロム・費用追加・返送方法などを専門機関が解説。',
    readTime: '7分',
    content: `
粉骨・洗骨を初めて依頼する個人の方が特に多く質問する10項目をまとめました。
...
スタンダード粉骨は当日〜3日。墓からの遺骨（洗骨+粉骨）は7〜12日。乾燥工程が必須のため短縮は難しいですが、最短スケジュールをご案内します。急ぎの場合は事前にご相談ください。
  ...
  {
    slug: 'comparison',
    title: '粉骨・洗骨・洗骨+粉骨セット・搬送サービスの横断比較表',
    category: 'cost',
    description: '遺骨.comが提供する粉骨・洗骨・洗骨+粉骨セット・出張搬送・郵送引取りの全サービスを工程数・納期・料金帯・対象者・法人対応の観点で比較。どのサービスを選ぶかの基準を提示します。',
    readTime: '5分',
    content: `
どのサービスを選べばよいかわからない方向けに、全サービスを同一基準で比較します。
...
export default async function GuidePage() {
  ...
  try {
    ...
    error = err;
    console.warn('Failed to fetch seo_articles from DB:', err);
  }

  // フォールバック付きのリスト構築
  const displayArticles = rawArticles && rawArticles.length > 0 ? rawArticles.map(a => ({
    slug: a.slug,
    title: a.title,
    category: a.category,
