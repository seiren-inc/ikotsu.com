...
export const metadata: Metadata = {
  title: '特定商取引法に基づく表記 | Ikotsu.com｜粉骨・洗骨の専門機関',
  description: 'Ikotsu.comの特定商取引法に基づく表記。サービス提供事業者、支払方法、キャンセル等についての法的な重要事項を記載しています。',
  alternates: { canonical: '/legal/tokushoho' },
};

const TOKUSHOHO_INFO = [
  { label: '販売事業者名（屋号）', value: 'Ikotsu.com（遺骨.com）' },
  ...
  { label: 'メールアドレス', value: 'info@ikotsu.com' },
