...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const coreRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${base}/contact/thanks`, lastModified: now, changeFrequency: 'yearly', priority: 0.1 },
    ...
    { url: `${base}/services/washing-and-pulverization`, lastModified: now, changeFrequency: 'monthly', priority: 0.85 },
    { url: `${base}/corporate`, lastModified: now, changeFrequency: 'monthly', priority: 0.85 },
    { url: `${base}/corporate/flow`, lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
