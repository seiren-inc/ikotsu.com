...
export const metadata: Metadata = {
  title: 'ご遺骨のお引取り（ご郵送）サービス｜全国対応｜Ikotsu.com',
...
const FAQS = [
  { question: '遺骨を郵送して法律上問題ありませんか？', answer: <p>はい、全く問題ありません。国内においてご遺骨を配送できるのは現在「日本郵便（ゆうパック）」のみとなっており、Ikotsu.comも日本郵便の公式ルールにしたがって安全な郵送お引取りサービスを提供しております。</p> },
        ...
        <div className="container">
          <FadeIn direction="up">
            ...
            <p className={styles.sectionDescCenter}>
              ご遺骨を安全に輸送するためには、骨壺にあったサイズの頑丈な段ボールと十分な緩衝材が不可欠です。Ikotsu.comでは、破損リスクをゼロに近づける「専用梱包キット」をご自宅まで無料でお届けしています。
            </p>
          </FadeIn>
